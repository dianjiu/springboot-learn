...
public class IDCardValidate {
    ...
    public static String getConstellationById(String idCard) {
        ...
        int month = IDCardValidate.getMonthByIdCard(idCard);
        int day = IDCardValidate.getDateByIdCard(idCard);
        String strValue = "";
    ...
    public static String getZodiacById(String idCard) { // 根据身份证号，自动返回对应的生肖
        ...
        int year = IDCardValidate.getYearByIdCard(idCard);
        int end = 3;
        int x = (year - end) % 12;
    ...
    public static void main(String[] args) {
        String idCard18 = "150102198807305428";
        String idCard15 = "150102880730303";
        System.out.println("根据身份编号校验是否合法(通用)：" + IDCardValidate.validateCard(idCard15));
        System.out.println("根据身份编号校验是否合法(通用)：" + IDCardValidate.validateCard(idCard18));
        System.out.println("校验18位身份证的合法性：" + IDCardValidate.validateIdCard18(idCard18));
        System.out.println("校验15位身份证的合法性：" + IDCardValidate.validateIdCard15(idCard15));
        System.out.println("15位身份证转18位身份证：" + IDCardValidate.conver15CardTo18(idCard15));
        System.out.println("根据身份编号获取性别为：" + IDCardValidate.getGenderByIdCard(idCard15));
        System.out.println("根据身份编号获取生日：" + IDCardValidate.getBirthByIdCard(idCard15));
        System.out.println("根据身份编号获取生日月：" + IDCardValidate.getMonthByIdCard(idCard15));
        System.out.println("根据身份编号获取生日天：" + IDCardValidate.getDateByIdCard(idCard15));
        System.out.println("根据身份证号，自动获取对应的星座：" + IDCardValidate.getConstellationById(idCard15));
        System.out.println("根据身份证号，自动获取对应的生肖：" + IDCardValidate.getZodiacById(idCard15));
        System.out.println("根据身份证号，自动获取对应的天干地支：" + IDCardValidate.getChineseEraById(idCard15));
        System.out.println("根据身份编号获取户籍省份：" + IDCardValidate.getProvinceByIdCard(idCard15));
    }
}
